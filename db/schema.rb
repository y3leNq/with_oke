...
ActiveRecord::Schema[7.0].define(version: 20_230_718_172_643) do
  ...
  create_table 'playlist_songs', force: :cascade do |t|
    ...
    t.index %w[playlist_id song_id], name: 'index_playlist_songs_on_playlist_id_and_song_id', unique: true
